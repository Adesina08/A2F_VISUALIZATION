...
st.sidebar.image("C:\\Users\\Adesina.Adeyemo\\Desktop\\OIP.jpg", use_column_width=True)
...
@st.cache_data
def load_data():
    return pd.read_csv("C:\\Users\\Adesina.Adeyemo\\Desktop\\A2F_FAP_v1.csv")
...
def load_polygon_geojson_selected_state(selected_state):
    file_path = f"C:\\Users\\Adesina.Adeyemo\\Downloads\\converted_files (2)\\{selected_state.upper()}.geojson"
    with open(file_path, "r", encoding="utf-8") as f:
        return json.load(f)
...
def page1():
    ...
    state_geojson_data = load_state_geojson(r"C:\Users\Adesina.Adeyemo\Downloads\ngaadmbndaadm1osgof20161215.geojson")
